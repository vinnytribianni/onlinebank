...
public class HomeEquityLoan {
    public static void main(String[] args) {
        ...
        while (loop == true) {
            // Menu
            System.out.println("");
            System.out.println("-------------------Welcome to Vincent's Bank Home Equity Loan Manager------------------");
            System.out.println("");
            Scanner menu = new Scanner(System.in);
            System.out.println("(1) Create a new home equity loan");
            System.out.println("(2) Open current home equity loan");
            ...
            if (selection == 3) {
                ...
                System.out.println("Enter estimated home value ($): ");
                homeValue = loanInfo.nextDouble();
                while (homeValue < 0) {
                    System.out.println("Invalid Home Value. Try Again.");
                    System.out.println("Enter estimated home value ($): ");
                    homeValue = loanInfo.nextDouble();
                }
                
                // Question 6: Mortgage Balance
                System.out.println("Enter current mortgage balance ($): ");
                mortgageBalance = loanInfo.nextDouble();
                while (mortgageBalance > homeValue) {
                    System.out.println("Mortgage balance cannot be greater than home value. Try again.");
                    System.out.println("Enter current mortgage balance ($): ");
                    mortgageBalance = loanInfo.nextInt();
                }
                ...
                while (loanAmount > maxLoanAmount) {
                    System.out.println("Invalid Loan Amount. Try Again.");
                    System.out.println("Enter loan amount ($): ");
                    loanAmount = loanInfo.nextDouble();
                }
